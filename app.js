...
// Firebase core SDKs ഇമ്പോർട്ട് ചെയ്യുന്നു (ഇവിടെ setDoc കൂടി ഇമ്പോർട്ട് ചെയ്തിട്ടുണ്ട്)
...
// ==========================================
// 7. 🔥 NEW USER SIGN-UP LOGIC (ഇത് പുതിയതായി ആഡ് ചെയ്തത്)
// ==========================================
// ഈ ഫങ്ഷൻ നിന്റെ Sign-Up പേജിലെ സബ്മിറ്റ് ബട്ടൺ ലോജിക്കിൽ കണക്ട് ചെയ്യാൻ ഉപയോഗിക്കാം.
window.handleRegisterUser = async (email, password, username) => {
    try {
        const formattedUsername = username.trim().toLowerCase(); // സെർച്ചിംഗ് എളുപ്പമാക്കാൻ lowercase ആക്കുന്നു
        
        // 1. Firebase Auth വഴി പുതിയ യൂസറെ ഉണ്ടാക്കുന്നു
        ...
        // 2. ഈ പുതിയ യൂസറുടെ വിവരങ്ങൾ Firestore 'users' കളക്ഷനിലേക്ക് കയറ്റുന്നു
        ...
        // 3. ബ്രൗസറിലെ ലോക്കൽ സ്റ്റോറേജിലേക്കും ഈ വിവരങ്ങൾ സേവ് ചെയ്യുന്നു
        const userInfo = {
            uid: newUid,
            username: formattedUsername,
            profilePic: defaultProfilePic
